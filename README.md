  ...
  <div class="row g-4 mt-2">
    ...
    <div class="col-md-4">
      <div class="project-card">
        <img src="drib.1.png" alt="Geometries" />
    ...
    <div class="col-md-4">
      <div class="project-card">
        <img src="drib.2.png" alt="Low Poly Designs" />
        <div class="project-info">
    ...
    <div class="col-md-4">
      <div class="project-card">
        <img src="drib.3.png" alt="Conspiracies" />
        <div class="project-info">
          <h6>Conspiracies</h6>
...
<div class="row g-4 mt-2">
    ...
    <div class="col-md-4">
      <div class="project-card">
        <img src="drib.4.png" alt="Geometries" />
        <div class="project-info">
          <h6>Geometries</h6>
          <p class="text-muted small">A project on geometric designs.</p>
        </div>
    ...
    <div class="col-md-4">
      <div class="project-card">
        <img src="drib.5.png" alt="Low Poly Designs" />
        <div class="project-info">
          <h6>Low Poly Designs</h6>
          <p class="text-muted small">A project on low poly designs.</p>
        </div>
    ...
    <div class="col-md-4">
      <div class="project-card">
        <img src="drib.6.png" alt="Conspiracies" />
        <div class="project-info">
          <h6>Conspiracies</h6>
          <p class="text-muted small">A project on conspiracies.</p>
        </div>
...
<footer style="background-color:rgb(58, 58, 58);height: 150;width: 1600px;color: white;text-align: center;font-family: cursive;font-size: 5;margin-top:30;">
    <h2 style="font-size:medium; margin-top: 4;">Email : dribbble@gmail.com </h2> <h2 style="font-size:medium;">Contact number : +91 9966400220</h2><br>
    <h2 style="font-size:medium;">Address  : No 44/7, Downs's street ,ECR highway ,chennai-600081</h2>
    <br>
    <h2 style="font-size:medium;">----------Developed by Divya Lakshmi M--------- </h2>
</footer>
</html>
...
![alt text](<divya/dribbleapp/static/Screenshot 2025-05-20 225317.png>)
![alt text](<divya/dribbleapp/static/Screenshot 2025-05-20 225524.png>)
![alt text](<divya/dribbleapp/static/Screenshot 2025-05-20 225601.png>)
![alt text](<divya/dribbleapp/static/Screenshot 2025-05-20 225627.png>)
